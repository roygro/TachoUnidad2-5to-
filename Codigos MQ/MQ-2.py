...
MQ2_PIN = 34  # GPIO donde conectaste la salida analógica del sensor MQ-2 (pin ADC)
...
# Inicializar el sensor MQ-2 como ADC (analógico)
...
def read_mq2_sensor():
    # Leer el valor del sensor MQ-2 (escala de 0 a 4095 en ESP32)
